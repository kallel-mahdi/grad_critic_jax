...
# Modified to use Minari datasets instead of D4RL
# Usage example:
...
class TD3BCConfig(BaseModel):
    ...
    #dataset_name: str = 'mujoco/halfcheetah/simple-replay-v0'  # Changed to minari dataset name
    dataset_name: str = 'D4RL/halfcheetah/medium-expert-v2'
    seed: int = 42
    eval_episodes: int = 5
...
if __name__ == "__main__":
    ...
    for i in tqdm.tqdm(range(1, num_steps + 1), smoothing=0.1, dynamic_ncols=True):
        ...
        if i % eval_interval == 0:
            ...
            eval_metrics = {f"{config.dataset_name}/normalized_score": normalized_score}
    ...
    wandb.log({f"{config.dataset_name}/final_normalized_score": normalized_score})
    wandb.finish()
